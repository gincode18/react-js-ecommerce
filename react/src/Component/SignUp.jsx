...
const Login = () => {
  return (
    <div className="flex flex-row items-center justify-center">
      <Lottie className="w-[40%] ml-[10%] hidden md:block " animationData={loginanimation} loop={true} />
      <div class="flex min-h-full flex-col justify-center px-6 py-12  flex-grow">
